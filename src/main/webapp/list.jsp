					...
					<div class="col l-10 m-12 c-12">
						...
						<ul class="home__pagination pagination ">
							<li class="pagination__item "><a
								href='/MVC/SearchController?search=${ search}&page=${back}'
								class="pagination__item-link"> <i
									class="fa-solid fa-angle-left"></i>
							</a></li>
							<c:forEach var="i" begin="1" end="${endPage }">
								<li
									class="pagination__item ${page==i ? 'pagination__item--active' : '' }"><a
									href="/MVC/SearchController?search=${ search}&page=${i}"
									class="pagination__item-link">${i }</a></li>
							</c:forEach>

							<li class="pagination__item"><a
								href='/MVC/SearchController?search=${ search}&page=${next}'
								class="pagination__item-link"> <i
